package com.gedoge.armor.example.rabbitmq.producer
...
class ExampleRabbitmqProducerApplication {
...
fun main(args: Array<String>) {
    SingletonContext.applicationContext = SpringApplication.run(ExampleRabbitmqProducerApplication::class.java, *args)
}
